...
def file_upload_to_s3(doc, method):
    ...
    if parent_doctype != "Data Import" and parent_doctype != "Wee Import Pricelist" and parent_doctype != "Landco Import Pricelist" and parent_doctype != "Demo Import Pricelist" and parent_doctype != "Import Pricelist" and parent_doctype != "Damosa Import Pricelist" and parent_doctype != "Duraville Import Pricelist":
